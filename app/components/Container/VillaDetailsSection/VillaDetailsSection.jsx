...
const VillaDetailsSection = ({ slug }) => {
  ...
  const { selectedVilla, weeklyPrice, loading } = useSelector(
    (state) => state.villas,
  );
  ...
  const isFavourite = useMemo(() => {
    ...
    return favourites.some((fav) => fav?.villaId?._id === selectedVilla._id);
  ...
  const calculateTotalPrice = () => {
    ...
    const displayPrice =
      selectedVilla.isOffer && selectedVilla.offerPrice
  ...
  useClickOutside(guestDropdownRef, () =>
